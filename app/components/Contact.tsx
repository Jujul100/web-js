...
export function Contact() {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/juliosalim',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/juliosalim',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Twitter',
      url: 'https://twitter.com/juliosalim',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:hello@juliosalim.dev',
      icon: (
                ...
                <div className="flex gap-4">
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      className="p-3 bg-accent text-foreground rounded-lg hover:bg-primary hover:text-primary-foreground transition-colors"
